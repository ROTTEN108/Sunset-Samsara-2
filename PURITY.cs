...
namespace PURITY
{
    ...
    public class PURITY : Mod, IMod, Modding.ILogger, IGlobalSettings<Settings>, IMenuMod
    {
        ...
        public override void Initialize(Dictionary<string, Dictionary<string, GameObject>> preloadedObjects)
        {
            ...
            Texture2D halo00 = LoadPng("PURITY.Resources.Halo0.png");
            ...
            Texture2D halo11 = LoadPng("PURITY.Resources.Halo1.png");
            ...
            BeamCannon = LoadAudioClip("PURITY.Resources.BeamCannon.wav");
            BeamCannon_H = LoadAudioClip("PURITY.Resources.BeamCannon_H.wav");
            Tik = LoadAudioClip("PURITY.Resources.tik.wav");
            Metal = LoadAudioClip("PURITY.Resources.metal.wav");
            Metal2 = LoadAudioClip("PURITY.Resources.metal_2.wav");
            ShieldBreak = LoadAudioClip("PURITY.Resources.ShieldBreak.wav");
            BGM1 = LoadAudioClip("PURITY.Resources.bgm1.wav");
            BGM2 = LoadAudioClip("PURITY.Resources.bgm2.wav");
            ...
            if (settings_.on == true)
            {
                if (HardMode == 0)
                {
                    ...
                    if (key == "GG_S_RADIANCE" && sheet == "CP3")
                    {
                        ...
                        {
                            text = "Purifying all things, death gives way to life.";
                        }
                    }
                    return text;
                }
            ...
            if(settings_.on)
            {
                ...
                if (self.gameObject.name == "Absolute Radiance" && self.FsmName == "Control")
                {
                    ...
                    self.GetState("Ascend Tele").AddMethod(() =>
                    {
                        ...
                        {
                            self.GetComponent<NailSkillRage>().On(0.15f, 0.3f);
                        }
                    });
                    ...
                    self.GetState("Final Impact").AddMethod(() =>
                    {
                        ...
                        foreach (GameObject go in allGameObjects)
                        {
                            ...
                            self.gameObject.GetComponent<BeamSkillP4>().enabled = false;
                            self.gameObject.GetComponent<OrbSkillP4>().enabled = false;
                            self.gameObject.GetComponent<NailSkill6_H>().enabled = false;
                        }
                    });
                        ...
                        if (ShieldOn)
                        {
                            if (HardMode == 0)
                            {
                                ...
                                else
                                {
                                    self.GetState("Final Idle").GetAction<WaitRandom>().timeMax = 2.5f;
                                    self.GetState("Final Idle").GetAction<WaitRandom>().timeMin = 2.5f;
                                    self.GetComponent<NailSkill4>().On(0.15f, 1.5f);
                                }
                            }
                            else
                            {
                                ...
                                else
                                {
                                    self.GetState("Final Idle").GetAction<WaitRandom>().timeMax = 2.5f;
                                    self.GetState("Final Idle").GetAction<WaitRandom>().timeMin = 2.5f;
                                    self.GetComponent<NailSkill4>().On(0.125f, 2.2f);
                                }
                            }
                        }
                    });
                ...
                {
                    self.GetComponent<tk2dSprite>().Collection.materials[0].mainTexture = LoadPng("PURITY.Resources.skin0.png");
                    self.GetComponent<tk2dSprite>().Collection.materials[1].mainTexture = LoadPng("PURITY.Resources.skin1.png");
                    self.GetComponent<tk2dSprite>().Collection.materials[2].mainTexture = LoadPng("PURITY.Resources.skin2.png");
        ...
        public class SceneSwitchDetector : MonoBehaviour
        {
            ...
            void OnSceneLoaded(Scene scene, LoadSceneMode mode)
            {
                ...
                /*
                var st = GameObject.Find("GG_Challenge_Statue_Canvas(Clone)").gameObject;
                var panel = st.transform.Find("Panel").gameObject;
                var name = panel.transform.Find("BossName_Text").gameObject;
                var decs = panel.transform.Find("Description_Text").gameObject;

                name.GetComponent<Text>().color = new Color(1f, 0.2196f, 0.1264f, 1f);
                decs.GetComponent<Text>().color = new Color(1f, 0.4396f, 0.4712f, 1f);
                */
            }
        }
        ...
        public class HaloControl : MonoBehaviour
        {
            ...
            void Start()
            {
                ...
                Texture2D halo1 = LoadPng("PURITY.Resources.Halo0.png");
        ...
        public class HaloAround : MonoBehaviour
        {
            ...
            float angle = 0f;
            float angleSpeed = 0f;
            float angleSpeedMax = 1.95f;
            float DefaultangleSpeedMax = 1.95f;
            float R = 0f;
            float RFactor = 0f;
            float side = 1f;
        ...
        public class HaloControl_Small:MonoBehaviour
        {
            ...
            void Start()
            {
                if(HALO1 == null)
                {
                    ...
                    Texture2D halo1 = LoadPng("PURITY.Resources.Halo1.png");
                    ...
                    case 1:
                        {
                            ...
                            else
                            {
                                ...
                                BOSS.GetComponent<NailSkill1>().On(0.045f, 0.04f);
                                BOSS.GetComponent<HaloControl>().Control(0f, 1f, 1.5f, false);
        ...
        */
        public class BossShieldControl : MonoBehaviour
        {
            ...
            public void FinalRecharge()
            {
                ...
                {
                    BOSS.GetComponent<HealthManager>().hp = 1020 + GameManager.instance.playerData.nailDamage * 35;
                }
            ...
            public void ReCharge()
            {
                if(!ShieldOn)
                {
                    ...
                    {
                        BOSS.GetComponent<HealthManager>().hp += 300 + GameManager.instance.playerData.nailDamage * 35;
                    }
            ...
            public void ReChargeRage()
            {
                ...
                {
                    BOSS.GetComponent<HealthManager>().hp = 2000 + 300 + GameManager.instance.playerData.nailDamage * 35;
                }
                BOSS.GetComponent<SpriteFlash>().flashDreamImpact();
                HALO1.GetComponent<HaloScaleChange_Small>().ShieldRecover();
                ShieldNeedRecharge = false;
        ...
        public class OrbImpact : MonoBehaviour
        {
            ...
            void End()
            {
                ...
                foreach (GameObject go in allGameObjects)
                {
                    if (go.name.Contains("Hero Hurter"))
                    {
                        go.Recycle();
                    }
                }
